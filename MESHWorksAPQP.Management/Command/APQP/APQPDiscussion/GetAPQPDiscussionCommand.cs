// <copyright file="GetAPQPDiscussionCommand.cs" company="MESHWorksAPQP">
...
namespace MESHWorksAPQP.Management.Command.APQP.APQPDiscussion
{
    ...
    /// <summary>
    /// Class GetAPQPDiscussionCommand.
    /// </summary>
    public class GetAPQPDiscussionCommand : IGetCommand<APQPDiscussionVM>
    {
        /// <summary>
